...
def test_create_game__when_game_is_new(
    game_create_data, repository_create_game_is_new_mock
):
...
def test_create_game__when_game_already_exists(
    game_create_data, repository_create_game_already_exists_mock
):
...
def test_update_game__when_game_already_exists_for_platform(
    game_update_data, repository_update_game_exists_for_platform_mock
):

    service = GameService(repository_update_game_exists_for_platform_mock)
...
def test_fetch_game__when_game_does_not_exists(
    repository_get_by_id_game_not_exists_mock,
):
    service = GameService(repository_get_by_id_game_not_exists_mock)
...
def test_fetch_game__when_game_exists(repository_get_by_id_game_exists_mock):
