...
def test_create_game_when_game_is_new(
...
def test_create_game_when_game_already_exists(
...
def test_update_game_when_success(game_update_data, repository_update_game_exists_mock):
...
def test_update_game_when_game_already_exists_for_platform(
...
def test_fetch_game_when_game_does_not_exists(
